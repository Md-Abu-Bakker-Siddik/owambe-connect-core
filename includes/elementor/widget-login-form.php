...
class OC_Widget_Login_Form extends Widget_Base {

	public function get_name()       { return 'oc_login_form'; }
	public function get_title()      { return __( 'OC Login Form', 'owambe-connect-core' ); }
	public function get_icon()       { return 'eicon-lock-user'; }
	public function get_categories() { return [ 'owambe-connect' ]; }
	public function get_keywords()   { return [ 'login', 'sign in', 'form', 'owambe' ]; }
	...
	protected function register_controls() {
		...
		$this->add_control( 'heading', [
			...
			'default'     => '',
			'placeholder' => __( 'Vendor Login', 'owambe-connect-core' ),
		] );
		...
		$this->add_control( 'subheading', [
			...
			'default'     => '',
			'placeholder' => __( 'Sign in to manage your listing.', 'owambe-connect-core' ),
		] );
		...
		$this->add_control( 'button_text', [
			...
			'type'        => Controls_Manager::TEXT,
			'default'     => '',
			'placeholder' => __( 'Log In', 'owambe-connect-core' ),
		] );
	...
	protected function render() {
		...
		echo do_shortcode( '[oc_login_form' . $attr . ']' );
	}
}
