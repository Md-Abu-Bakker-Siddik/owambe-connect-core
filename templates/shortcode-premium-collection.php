<?php
/**
 * Premium Collection vendors carousel.
 *
...
$heading       = ! empty( $heading ) ? $heading : __( 'Premium Collection', 'owambe-connect-core' );
$subheading    = ! empty( $subheading ) ? $subheading : __( 'Explore standout professionals offering elevated service for unforgettable celebrations.', 'owambe-connect-core' );
...
$interval      = ! empty( $interval ) ? absint( $interval ) : 6500;
$heading_id    = wp_unique_id( 'oc-premium-collection-title-' );
$track_id      = wp_unique_id( 'oc-premium-collection-track-' );
?>
<section class="oc-section oc-home-carousel oc-premium-collection" aria-labelledby="<?php echo esc_attr( $heading_id ); ?>">
	<div class="oc-container">
		...
		>
			<button
				...
				aria-label="<?php esc_attr_e( 'Show previous premium vendors', 'owambe-connect-core' ); ?>"
			>&#8249;</button>
			...
			<button
				...
				aria-controls="<?php echo esc_attr( $track_id ); ?>"
				aria-label="<?php esc_attr_e( 'Show more premium vendors', 'owambe-connect-core' ); ?>"
			>&#8250;</button>
		</div>
